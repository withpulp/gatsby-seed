...
const Head = ({
    ...
    <Helmet>
        ...
        <meta content={services.facebookAppId} property="fb:app_id" />
        <meta content="summary_large_image" name="twitter:card" />
        <meta content={`@${services.twitterHandle}`} name="twitter:site" />
        <meta content={`@${services.twitterHandle}`} name="twitter:creator" />
...
Head.propTypes = {
    ...
    networks: PropTypes.arrayOf(PropTypes.objectOf(PropTypes.string)),
...
const HeadWithQuery = props => (
    <StaticQuery
        ...
        `}
        render={data => (
            <Head {...data.site.siteMetadata} {...props} />
        )}
    />
);
